...
BUILTIN_GCODE = {
    ...
    "KAOS_LOG_LEVEL",
    "KAOS_LOG_FLAGS",
    # KAOS Motion Guard commands (registered by phrozen_dev/kaos_motion_guard.py).
    "KAOS_MOTION_GUARD_ARM",
    "KAOS_MOTION_GUARD_DISARM",
    "KAOS_MOTION_GUARD_TRUST_XYZ",
    "KAOS_MOTION_GUARD_TRUST_XY",
    "KAOS_MOTION_GUARD_TRUST_Z",
    "KAOS_MOTION_GUARD_CLEAR_TRUST",
    "KAOS_MOTION_GUARD_AUTHORIZE_RECOVERY",
    "KAOS_MOTION_GUARD_CLEAR_RECOVERY_AUTH",
    "KAOS_MOTION_GUARD_STATUS",
    "KAOS_HOME_IF_NEEDED",
